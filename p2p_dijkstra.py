...
def quaternion_a_angulos_de_euler(quaternion):
    ...
    """
    # Convertir cuaternion a angulos de Euler
...
#    print("vel_der: ", velocidad_der)
    ...
    if distancia < 1 and punto_actual_trayectoria == len(trayectoria) - 1:
        drive_msg.left = 0
        drive_msg.right = 0
        print("He terminado")
    ...
    if distancia < 2 and punto_actual_trayectoria < len(trayectoria) - 1:
        punto_actual_trayectoria += 1


def dijkstra(matriz_costos, puntos, inicio, objetivo):
    """
    Genera la trayectoria dado la matriz de costes, los posibles puntos de acceso,
    el punto de inicio y el objetivo mediante el algoritmo de dijkstra
    ...
    # Bucle principal
    for i in range(n):
        # Encontrar el nodo no visitado con la distancia mas pequena
        u = min((distancia[i], i) for i, visit in enumerate(visitado) if not visit)[1]
        visitado[u] = True
    ...
    # Reconstruir el camino optimo
    camino = []
    v = indices[objetivo]
    while v != -1:
        camino.append(puntos[v])
        v = padre[v]
    camino.reverse()
...
def main():
    ...
    se escogerá la trayectoria mediante el método dijkstra y mediante un control PID,
    ...
    puntos = [(-10, -10), (-5, -5), (-10, -5), (-5, -10), (0, 0), (10, 10), (5, 5), (10, 5), (5, 10), (-10, 10), (-5, 5), (-10, 5), (-5, 10), (10, -10), (5, -5), (10, -5), (5, -10), (-10,0), (-5,0), (5,0), (10,0), (0, -10), (0, -5), (0, 5), (0, 10)] 

    # Matriz de costes
    costes = 'pesos_mod.txt'
    matriz_costos = cargar_matriz_desde_txt(costes)

    #Calcular la trayectoria optima
    trayectoria_sin_interpolar = dijkstra(matriz_costos, puntos, inicio, objetivo)
